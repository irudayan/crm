...
<div class="card">
    <div class="card-header">
        <div class="row align-items-center">
            ...
            &nbsp;&nbsp;
            <a class="btn btn-sm btn-success" href="{{ route('admin.followUp.export') }}"
                    ...
                    <tr data-entry-id="{{ $lead->id }}" @if($lead->is_pinned) style="background-color: #fff3cd;" @endif>
                        ...
                        <td>
                            ...
                            <button class="btn btn-xs btn-warning edit-lead" data-id="{{ $lead->id }}"
                                ...
                                data-assigned_to_remarks="{{ $lead->assigned_to_remarks }}"
                                data-opened_at="{{ $lead->opened_at }}" data-follow_date="{{ $lead->follow_date }}"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" id="mail_follow_date" name="follow_date" class="form-control"
                                    required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="time" id="mail_follow_time" name="follow_time" class="form-control"
                                    required>
                            </div>
                        </div>
                    </div>
