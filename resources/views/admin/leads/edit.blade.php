                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="edit_name" class="form-control" name="name" required maxlength="20">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="edit_mobile">{{ trans('cruds.leads.fields.mobile') }}</label>
                                {{-- <input type="text" id="edit_mobile" class="form-control" name="mobile" required maxlength="20"> --}}
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" id="edit_email" class="form-control" name="email" required maxlength="25">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="product_ids[]" id="product_ids" class="form-control select2" multiple
                                    ...
                                    @foreach ($products as $id => $product)
                                        <option value="{{ $product->id }}"
                                            {{ in_array($id, old('product_ids', [])) || $lead->products->contains($id) ? 'selected' : '' }}>
                                            {{ $product }}</option>
                                    @endforeach
