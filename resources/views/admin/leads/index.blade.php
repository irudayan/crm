                ...
                <table class="table table-bordered table-striped table-hover datatable datatable-Lead">
                    <thead>
                        ...
                        <tr>
                            ...
                            <td><input class="search form-control" type="text" placeholder="Search Status"></td>
                                ...
                                <td>
                                    @php
                                        $statuses = [
                                            ...
                                            'Online Demo' => 'primary',
                                            'Offline Demo' => 'danger',
                                            'Onsite Visit' => 'secondary',
                                            'Quotation / Ready To Buy' => 'dark',
                                            'Closed or Won' => 'success',
                                            'Dropped or Cancel' => 'light',
                                        ];
                                        $badgeClass = $statuses[$lead->status] ?? 'light';
                                    @endphp
                                    <span class="badge badge-{{ $badgeClass }}">{{ $lead->status ?? 'Unknown' }}</span>
                                </td>
...
{{--
    @section('styles')
        @parent
        <style>
            tr[data-entry-id] td:first-child {
                width: 40px;
                text-align: center;
            }
            .fa-thumbtack {
...
@section('scripts')
    ...
    <script>
        ...
        $('.view-lead').on('click', function() {
            let assignedName = $(this).data('assigned_name');
            // let assignedBy = $(this).data('assigned_by_id'); // NEW
