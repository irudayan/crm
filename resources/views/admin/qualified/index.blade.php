...
@section('title', __('cruds.qualified.title'))
@section('content')
    <p>&nbsp;</p>
    @if (session('success'))
        ...
        <div class="card-header">
            <div class="row align-items-center">
                <div class="col-lg-10 col-sm-10 col-md-10 col-xs-12">
                    <h5>{{ trans('cruds.qualified.title_singular') }} {{ trans('global.list') }}</h5>
                </div>
                ...
                href="{{ route('admin.qualified.export') }}"
                            ...
                            <td>{{ $lead->id }}</td>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-xs btn-primary view-lead" href="#"
                                        ...
                                        data-address="{{ $lead->address }}" data-industry="{{ $lead->industry }}"
                                         data-source="{{ $lead->source }}"  data-assigned_by="{{ $lead->assignedBy->name ?? 'Not Assigned' }}"
                                    ...
                                    <button class="btn btn-xs btn-warning edit-lead" data-id="{{ $lead->id }}"
                                        ...
                                        data-status="{{ $lead->status }}" data-purpose="{{ $lead->purpose }}"
                                        data-remarks="{{ $lead->remarks }}" data-assigned_to_remarks="{{ $lead->assigned_to_remarks }}" data-opened_at="{{ $lead->opened_at }}"
