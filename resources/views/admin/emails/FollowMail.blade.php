...
<body>
    ...
    <h2>Lead Follow Information</h2>

    <ul>
        <li><strong>Follow Date:</strong> {{ $lead->follow_date }}</li>
        <li><strong>Follow Time:</strong> {{ \Carbon\Carbon::parse($lead->follow_time)->format('h:i A') }}</li>
    </ul>
