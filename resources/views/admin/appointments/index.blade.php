                            ...
                            <td style="text-align: center;">
                                ...
                                <td>
                                      ...
                                      <button class="btn btn-xs btn-warning edit-lead" data-id="{{ $lead->id }}"
                                        ...
                                        data-follow_time="{{ $lead->follow_time }}" data-products="{{ json_encode($lead->products->pluck('id')) }}" data-toggle="modal" data-target="#editLeadsModal">
                                    ...
                                    <a class="btn btn-xs btn-primary view-lead" href="#"
                                        ...
                                        data-status="{{ $lead->status }}" data-purpose="{{ $lead->purpose }}"
                                        data-remarks="{{ $lead->remarks }}" data-assigned_to_remarks="{{ $lead->assigned_to_remarks }}" data-opened_at="{{ $lead->opened_at }}" data-demo_date="{{ $lead->demo_date }}" data-demo_time="{{ $lead->demo_time }}"
                ...
                <div class="modal-body">
                    ...
                    {{-- <form action="{{ isset($lead) ? route('admin.send.demo', $lead->id) : '#' }}" method="POST"> --}}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="required" for="date">{{ trans('cruds.appointments.fields.date') }}</label>
                                    <input type="date" name="demo_date" class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="required" for="time">{{ trans('cruds.appointments.fields.time') }}</label>
          ...
          $('#edit_status').on('change', function () {
            ...
            $('.view-lead').on('click', function() {
                ...
                $('#viewProducts').text(products ? products : 'No Products');
                  ...
                  // ✅ Fill demo date/time if exists
                const demoDate = $(this).data('demo_date');
                const demoTime = $(this).data('demo_time');

                $('input[name="demo_date"]').val(demoDate ?? '');
                $('input[name="demo_time"]').val(demoTime ?? '');

                // ✅ Update form action dynamically
                const routeUrl = `/admin/send-demo/${leadId}`;
