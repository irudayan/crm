...
// public function sendQuotationEmail( $id, Request $request)
// {
//     // dd($id, $request->all());
//    $request->validate([
...
//     try{
//  $lead = Leads::findOrFail($id); // Use ID from URL
// // dd($lead);
//     // if (!$lead->quotation_pdf_path) {
//     //     dd('in');
...
//     Mail::to($email)->send(new QuotationMail($lead, $pdfPath, $senderEmail, $senderName));
...
// public function sendQuotationEmail($leadId, Request $request)
// {
//     $request->validate([
//         'email' => 'required|email',
//     ]);
...
//         // Send email
//         Mail::to($request->email)->send(new QuotationMail($lead, $pdfPath, $senderEmail, $senderName));
